...
/// for blind signing.
module initia_std::permissioned_signer {
    use std::signer;
    use std::error;
    use std::vector;
    ...
    use initia_std::transaction_context::generate_unique_address;
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1C5, location = initia_std::bcs)]
