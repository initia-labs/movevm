...
module initia_std::nft {
    ...
    inline fun create_common(
        ...
        assert!(string::length(&token_id) <= MAX_NFT_TOKEN_ID_LENGTH,
        ...
        let nft =
            Nft { collection, description, token_id, uri, };
    ...
    inline fun borrow<T: key>(nft: Object<T>): &Nft acquires Nft {
        ...
        assert!(exists<Nft>(nft_address), error::not_found(ENFT_DOES_NOT_EXIST),);
    ...
    inline fun borrow_mut(mutator_ref: &MutatorRef): &mut Nft acquires Nft {
        assert!(exists<Nft>(mutator_ref.self), error::not_found(ENFT_DOES_NOT_EXIST),);
    ...
    fun test_create_and_transfer(creator: &signer, trader: &signer) acquires Nft {
        ...
        let expected_royalty =
            royalty::create(initia_std::decimal128::from_ratio(25, 10000), creator_address);
    ...
    fun test_collection_royalty(creator: &signer) acquires Nft {
        ...
        let creator_address = signer::address_of(creator);
        let expected_royalty =
            royalty::create(initia_std::decimal128::from_ratio(10, 1000), creator_address);
    ...
    fun test_set_description(creator: &signer) acquires Nft {
        ...
        let nft =
            object::address_to_object<Nft>(create_nft_address(signer::address_of(creator), &collection_name, &token_id),);
    ...
    fun test_burn_with_royalty(creator: &signer) acquires Nft {
        ...
        let constructor_ref =
            create(creator,
                ...
                string::utf8(b"nft description"),
                token_id,
                option::some(royalty::create(initia_std::decimal128::from_ratio(1, 1),
    ...
    fun create_nft_helper(
        ...
        create(creator,
            ...
            string::utf8(b"nft description"),
            token_id,
            option::some(royalty::create(initia_std::decimal128::from_ratio(25, 10000),
                    signer::address_of(creator))),
            string::utf8(b"uri"),)
    }
