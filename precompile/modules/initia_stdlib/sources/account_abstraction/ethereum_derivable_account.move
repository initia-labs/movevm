...
module initia_std::ethereum_derivable_account {
    ...
    fun test_recover_public_key() {
        ...
        let hashed_message = keccak256(message);
        let signature_bytes = vector[
            146, 244, 18, 219, 201, 64, 65, 209, 118, 141, 224, 9, 205, 17, 201, 42, 188, 231, 125, 218, 214, 69, 105, 66, 4, 212, 131, 234, 226, 144, 9, 189, 65, 131, 126, 86, 221, 17, 221, 193, 109, 129, 139, 83, 109, 163, 88, 108, 244, 140, 77, 181, 197, 79, 156, 10, 238, 95, 79, 140, 167, 216, 226, 2, 27
        ];
        let base64_public_key = recover_public_key(&signature_bytes, &hashed_message);
        assert!(
            base64_public_key
                == vector[
                    4, 148, 150, 223, 27, 162, 228, 138, 169, 39, 173, 25, 198, 189, 68, 144, 21, 144, 62, 13, 253, 189, 67, 220, 2, 253, 21, 22, 39, 210, 27, 9, 255, 142, 148, 255, 85, 235, 2, 44, 126, 177, 161, 163, 27, 107, 215, 19, 94, 233, 237, 78, 153, 253, 214, 121, 252, 27, 82, 106, 16, 118, 145, 59, 58
                ]
        );
    }
