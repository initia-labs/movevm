module initia_std::vip_zapping {
    ...
    #[view]
    public fun get_delegation_infos(zids: vector<u64>): vector<DelegationInfo> acquires ModuleStore {
        let delegation_infos = vector[];
        vector::enumerate_ref(
            &zids,
            |_i, zid| {
    ...
    #[test(chain = @0x1, initia_std = @initia_std, account = @0x999)]
    fun test_zapping(
        chain: &signer,
        initia_std: &signer,
        account: &signer,
        ...
        assert!(
            zapping.release_time == release_time + 1, 3
        );
    }
    ...
    #[test(chain = @0x1, initia_std = @initia_std, account = @0x3, relayer = @0x3d18d54532fc42e567090852db6eb21fa528f952)]
    ...
    #[test(chain = @0x1, initia_std = @initia_std, user_a = @0x998, user_b = @0x999, relayer = @0x3d18d54532fc42e567090852db6eb21fa528f952)]
    fun test_zapping_claim(
        ...
        coin::deposit(
            signer::address_of(user_b), stakelisted
        );
    ...
    #[test(chain = @0x1, initia_std = @initia_std, account = @0x2)]
