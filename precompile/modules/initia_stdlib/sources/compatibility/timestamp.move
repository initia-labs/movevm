...
module initia_std::timestamp {
    use initia_std::block::{get_block_info, get_current_block_timestamp_milliseconds, get_current_block_timestamp_microseconds, get_current_block_timestamp_nanoseconds};
    ...
    #[test_only]
    use initia_std::block::{set_block_info, set_block_info_nanos, get_block_info_nanos};
