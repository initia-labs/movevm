...
module initia_std::primary_fungible_store {
    use initia_std::fungible_asset::{Self, FungibleAsset, FungibleStore, Metadata, MintRef, TransferRef, BurnRef};
    ...
    #[test_only]
    use initia_std::fungible_asset::{create_test_token, generate_mint_ref, generate_burn_ref, generate_transfer_ref};
    #[test_only]
    use std::string;
