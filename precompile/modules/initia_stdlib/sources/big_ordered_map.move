...
module initia_std::big_ordered_map {
    use std::error;
    use std::vector;
    ...
    fun print_map_for_node<K: store + copy + drop, V: store>(
        ...
        initia_std::debug::print(&level);
        initia_std::debug::print(&node_index);
    ...
    #[test]
    #[expected_failure(abort_code = 0x10002, location = initia_std::ordered_map)]
    /// EKEY_NOT_FOUND
