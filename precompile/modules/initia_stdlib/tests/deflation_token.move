...
module 0xcafe::deflation_token {
    use initia_std::fungible_asset::{Self, BurnRef, FungibleAsset, TransferRef};
    use initia_std::dispatchable_fungible_asset;
    use initia_std::object::{ConstructorRef, Object};
    ...
    #[test_only]
    use initia_std::fungible_asset::{Metadata, TestToken};

    #[test(creator = @0xcafe)]
    #[expected_failure(major_status = 4037, location = initia_std::dispatchable_fungible_asset)]
