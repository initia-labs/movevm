module std::cmp {
    ...
    fun test_compare_vectors() {
        ...
        assert!(
            compare(&vector[1], &vector[]) is Ordering::Greater,
            2
        );
        assert!(
    ...
    fun test_compare_enums() {
        assert!(
            compare(&SomeEnum::V1 { field_1: 6 }, &SomeEnum::V1 { field_1: 6 }) is Ordering::Equal,
            0
        );
        assert!(
            compare(&SomeEnum::V1 { field_1: 6 }, &SomeEnum::V2 { field_2: 1 }) is Ordering::Less,
            1
        );
        assert!(
            compare(&SomeEnum::V1 { field_1: 6 }, &SomeEnum::V2 { field_2: 8 }) is Ordering::Less,
            2
        );
        assert!(
            compare(&SomeEnum::V1 { field_1: 6 }, &SomeEnum::V1 { field_1: 5 }) is Ordering::Greater,
            3
        );

        assert!(
            compare(
                &SomeEnum::V3 { field_3: SomeStruct { field_1: 1, field_2: 2 } },
                &SomeEnum::V3 { field_3: SomeStruct { field_1: 1, field_2: 2 } }
            ) is Ordering::Equal,
            4
        );
        assert!(
            compare(
                &SomeEnum::V3 { field_3: SomeStruct { field_1: 1, field_2: 2 } },
                &SomeEnum::V3 { field_3: SomeStruct { field_1: 1, field_2: 3 } }
            ) is Ordering::Less,
            5
        );
        assert!(
            compare(
                &SomeEnum::V3 { field_3: SomeStruct { field_1: 1, field_2: 2 } },
                &SomeEnum::V3 { field_3: SomeStruct { field_1: 1, field_2: 1 } }
            ) is Ordering::Greater,
            6
        );
        assert!(
        ...
        assert!(
            compare(
                &SomeEnum::V4 { field_4: vector[1, 2] },
                &SomeEnum::V4 { field_4: vector[1, 2] }
            ) is Ordering::Equal,
            8
        );
        assert!(
            compare(
                &SomeEnum::V4 { field_4: vector[1, 2, 3] },
                &SomeEnum::V4 { field_4: vector[5] }
            ) is Ordering::Less,
            9
        );
        assert!(
            compare(
                &SomeEnum::V4 { field_4: vector[1, 2, 3] },
                &SomeEnum::V4 { field_4: vector[5, 6, 7] }
            ) is Ordering::Less,
            10
        );
        assert!(
            compare(
                &SomeEnum::V4 { field_4: vector[1, 2, 3] },
                &SomeEnum::V4 { field_4: vector[1, 2, 7] }
            ) is Ordering::Less,
            11
        );
        ...
        assert!(
            compare(
                &SomeEnum::V5 { field_5: SimpleEnum::V { field: 3 } },
                &SomeEnum::V5 { field_5: SimpleEnum::V { field: 3 } }
            ) is Ordering::Equal,
            12
        );
        assert!(
            compare(
                &SomeEnum::V5 { field_5: SimpleEnum::V { field: 5 } },
                &SomeEnum::V5 { field_5: SimpleEnum::V { field: 3 } }
            ) is Ordering::Greater,
            13
        );
