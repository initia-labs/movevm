...
module 0xcafe::deflation_token {
    use minitia_std::fungible_asset::{Self, BurnRef, FungibleAsset, TransferRef};
    ...
    #[test_only]
    use minitia_std::fungible_asset::{Metadata, TestToken};

    #[test(creator = @0xcafe)]
    #[expected_failure(major_status = 4037, location = minitia_std::dispatchable_fungible_asset)]
