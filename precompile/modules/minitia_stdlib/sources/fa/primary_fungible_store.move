...
module minitia_std::primary_fungible_store {
    use minitia_std::fungible_asset::{Self, FungibleAsset, FungibleStore, Metadata, MintRef, TransferRef, BurnRef};
    use minitia_std::object::{Self, Object, ConstructorRef, DeriveRef};
    ...
    #[test_only]
    use minitia_std::fungible_asset::{create_test_token, generate_mint_ref, generate_burn_ref, generate_transfer_ref};
    #[test_only]
    use std::string;
    ...
    fun test_default_behavior(creator: &signer, aaron: &signer, mod_account: &signer) acquires DeriveRefPod, ModuleStore {
    ...
    #[test(user_1 = @0xcafe, user_2 = @0xface, mod_account = @0x1)]
