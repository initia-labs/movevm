...
module minitia_std::object_code_deployment {
    use std::bcs;
    use std::error;
    use std::signer;
    use std::vector;
    use minitia_std::account;
    use minitia_std::code::{Self, MetadataStore};
    ...
    const OBJECT_CODE_DEPLOYMENT_DOMAIN_SEPARATOR: vector<u8> = b"minitia_std::object_code_deployment";
