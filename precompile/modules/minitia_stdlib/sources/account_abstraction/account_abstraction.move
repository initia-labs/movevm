module minitia_std::account_abstraction {
    use std::bcs;
    use std::hash;
    ...
    use minitia_std::ordered_map::{Self, OrderedMap};
    use minitia_std::big_ordered_map::{Self, BigOrderedMap};
    ...
    public entry fun register_derivable_authentication_function(
        ...
        DerivableDispatchableAuthenticator[@minitia_std].auth_functions.add(
            function_info::new_function_info_from_address(
                module_address, module_name, function_name
            ),
    ...
    inline fun resource_addr(source: address): address {
        object::create_user_derived_object_address(source, @minitia_std)
    }
    ...
    inline fun dispatchable_derivable_authenticator_internal():
        ...
        &DerivableDispatchableAuthenticator[@minitia_std].auth_functions
    }
