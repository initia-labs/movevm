...
macro_rules! define_gas_parameters {
    (
        ...
        impl $crate::meter::FromOnChainGasSchedule for $params_name {
        ...
        impl $crate::meter::ToOnChainGasSchedule for $params_name {
        ...
        impl $crate::meter::InitialGasSchedule for $params_name {
            fn initial() -> Self {
                Self {
                    $($name: $initial.into()),*
                }
...
#[cfg(test)]
mod tests {
    use crate::meter::FromOnChainGasSchedule;
