...
crate::params::define_gas_parameters!(
    ...
    [
        ...
        [ld_u16: InternalGas, "ld_u16", 1200],
        [ld_u32: InternalGas, "ld_u32", 1200],
        [ld_u64: InternalGas, "ld_u64", 1200],
        [ld_u128: InternalGas, "ld_u128", 1600],
        [ld_u256: InternalGas, "ld_u256", 1600],
        ...
        [call_per_local: InternalGasPerArg, "call.per_local", 2000],
        ...
        [
            call_generic_per_local: InternalGasPerArg,
            "call_generic.per_local",
            2000
        ],
        // struct
        ...
        [cast_u16: InternalGas, "cast_u16", 2400],
        [cast_u32: InternalGas, "cast_u32", 2400],
        [cast_u64: InternalGas, "cast_u64", 2400],
        [cast_u128: InternalGas, "cast_u128", 2400],
        [cast_u256: InternalGas, "cast_u256", 2400],
        // arithmetic
