...
crate::macros::define_gas_parameters!(
    ...
    [cosmos_stargate_per_byte: InternalGasPerByte, "cosmos.stargate.per_byte", 7],
    [cosmos_move_execute_base: InternalGas, "cosmos.move_execute.base", 1000 * SCALING],
    [cosmos_move_execute_per_byte: InternalGasPerByte, "cosmos.move_execute.per_byte", 18],
    [cosmos_move_script_base: InternalGas, "cosmos.move_script.base", 1000 * SCALING],
    [cosmos_move_script_per_byte: InternalGasPerByte, "cosmos.move_script.per_byte", 18],
    [cosmos_delegate_base: InternalGas, "cosmos.delegate.base", 1000 * SCALING],
    [cosmos_delegate_per_byte: InternalGasPerByte, "cosmos.delegate.per_byte", 18],
    [cosmos_fund_community_pool_base: InternalGas, "cosmos.fund_community_pool.base", 1000 * SCALING],
    [cosmos_fund_community_pool_per_byte: InternalGasPerByte, "cosmos.fund_community_pool.per_byte", 18],
    [cosmos_transfer_base: InternalGas, "cosmos.transfer.base", 1000 * SCALING],
    [cosmos_transfer_per_byte: InternalGasPerByte, "cosmos.transfer.per_byte", 18],
    [cosmos_nft_transfer_base: InternalGas, "cosmos.nft_transfer.base", 1000 * SCALING],
    [cosmos_nft_transfer_per_token: InternalGasPerArg, "cosmos.nft_transfer.per_token", 10 * SCALING],
    [cosmos_nft_transfer_per_byte: InternalGasPerByte, "cosmos.nft_transfer.per_byte", 18],
    [cosmos_pay_fee_base: InternalGas, "cosmos.pay_fee.base", 1000 * SCALING],
    [cosmos_pay_fee_per_byte: InternalGasPerByte, "cosmos.pay_fee.per_byte", 18],
